...
import template from './byu-fancy-component.html';
...
class ByuFancyComponent extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    util.applyTemplate(this, 'byu-fancy-component', template, () => {
...
window.customElements.define('byu-fancy-component', ByuFancyComponent);
window.ByuFancyComponent = ByuFancyComponent;
